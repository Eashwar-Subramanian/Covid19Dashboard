...
SELECT location,population,date,MAX(CAST(total_cases AS UNSIGNED)) AS Highest_Infection_count,MAX((CAST(total_cases AS UNSIGNED)/population))*100 AS Percent_Population_infected
FROM covid19death.`covid19  deaths`
